...
void Task(node<T> *&head)
{
    ...
    Display_pair(ExtractedList);
    cout<<endl;

    cout<<"Remaining Elements in Original List:"<<endl;
    Display_pair(NewList);
    cout<<endl;
...
int main()
{
    ...
    node<pair<int,string>> *head3=NULL;
    Inserttail<pair<int,string>>(head3,make_pair(4489,"abdullah"));
    Inserttail<pair<int,string>>(head3,make_pair(4000,"shayan"));
    Inserttail<pair<int,string>>(head3,make_pair(4590,"habib"));
    Inserttail<pair<int,string>>(head3,make_pair(1234,"hasnain"));
    Inserttail<pair<int,string>>(head3,make_pair(6789,"Moiz"));
    Inserttail<pair<int,string>>(head3,make_pair(4567,"Usama"));
    Display_pair(head3);
    Task(head3);
